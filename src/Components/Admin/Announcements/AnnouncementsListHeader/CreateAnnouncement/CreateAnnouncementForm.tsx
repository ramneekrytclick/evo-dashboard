...
const CreateAnnouncementForm = ({ toggle }: { toggle: () => void }) => {
	...
	const handleCheckboxChange = (role: string) => {
		setFormData((prevState) => {
			const updatedAudience = prevState.targetAudience.includes(role)
				? prevState.targetAudience.filter((r) => r !== role)
				: [...prevState.targetAudience, role];
			return { ...prevState, targetAudience: updatedAudience };
		});
	};
