import { deleteEmployerConfirmTitle, ImagePath } from "@/Constant";
import React, { useState } from "react";
import { Button } from "reactstrap";

import CommonModal from "@/CommonComponent/CommonModal";
import Image from "next/image";
import { deleteEmployer } from "@/app/api/admin/employers";



const DeleteEmployerModal = ({id,fetchData}:{id:string,fetchData:()=>Promise<void>}) => {
		...
		<>
			...
			<CommonModal modalData={ModalData}>
				<div className="modal-toggle-wrapper text-center">
					<h3 className="mb-3">{deleteEmployerConfirmTitle}</h3>
